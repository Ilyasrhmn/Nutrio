...
import { checkpointDefinitions, mockAIResults } from "@/lib/mock-data/checkpoints";
      ...
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500">Semua tahapan operasional hari ini telah diverifikasi oleh AI.</p>
          </div>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-white border-b border-slate-200 py-6">
        <StepIndicator 
          ...
          steps={checkpointDefinitions.map(d => ({ id: d.id, label: d.label }))}
        />
      </div>
        ...
        {isAnalyzing && (
          <div className="flex flex-col items-center justify-center p-8 space-y-4 bg-slate-50 rounded-2xl border border-dashed border-slate-300">
            ...
            <div className="text-center">
              <p className="font-bold text-slate-900">AI sedang menganalisa...</p>
              <p className="text-xs text-slate-500">Memverifikasi kebersihan dan standar gizi</p>
            </div>
          </div>
        )}
