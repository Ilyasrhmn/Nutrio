      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold text-foreground tracking-tight">
            Panel Eksekusi Checkpoint AI
          </h2>
          <p className="text-muted-foreground text-sm font-medium">
            Validasi aktivitas dapur secara real-time untuk mencegah penalti
            keterlambatan.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          <Alert className="w-full md:w-[240px] bg-blue-50 border-blue-100 shadow-sm py-2">
            ...
            <div className="flex flex-col ml-2">
              <span className="text-[9px] font-black uppercase tracking-widest text-blue-900 leading-none">
                GPS Dapur
              </span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between w-full gap-4">
            <div>
              <div className="text-xs font-black uppercase tracking-widest mb-1">
                ATURAN EMAS NO. 8: ZONA AMAN 4 JAM
              </div>
            ...
            <div className="bg-white/20 px-4 py-2 rounded-xl border border-white/30 backdrop-blur-sm">
              <p className="text-[10px] font-black uppercase tracking-widest leading-none opacity-80 text-white">
                Sisa Waktu Aman
              </p>
        ...
        <Card className="lg:col-span-2 border-border bg-card shadow-2xl shadow-slate-200/50 rounded-[32px] overflow-hidden">
          ...
          <CardContent className="p-8 space-y-8">
            <div className="relative group">
              <div className="absolute -inset-1 bg-linear-to-r from-primary to-indigo-600 rounded-[32px] blur opacity-10 group-hover:opacity-20 transition duration-1000" />
            ...
            <CardContent className="p-0">
              {steps.map((step) => {
                ...
                return (
                  <div
                    key={step.id}
                    className="p-5 flex items-center gap-4 opacity-50 grayscale border-b border-border/50 last:border-0"
                  >
          ...
          <Card className="border-amber-100 bg-amber-50/50 shadow-sm">
            <CardContent className="p-5 space-y-3">
              ...
              <p className="text-[11px] text-amber-800 leading-relaxed font-medium">
                Jika terjadi insiden darurat (ban bocor, kecelakaan, dll),
                segera lapor melalui menu <b>Pusat Kendali Insiden</b> untuk
                penyesuaian pinalti.
              </p>
              <Button
                variant="outline"
                className="w-full h-8 text-[10px] font-black uppercase border-amber-200 text-amber-700 hover:bg-amber-100"
              >
