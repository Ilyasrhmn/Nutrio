      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-medium max-w-2xl text-sm leading-relaxed">
            Kelola perencanaan menu harian dan pantau target demand zona MBG
            Anda.
          </p>
        </div>
        ...
        <Card className="bg-card border-border shadow-sm rounded-2xl">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-black text-foreground">
                600 <span className="text-xs font-bold opacity-40">kcal</span>
              </p>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <Badge
                        variant="outline"
                        className="rounded-full text-[10px] font-bold border-border bg-emerald-50 text-emerald-700"
                      >
                        610 kcal (Optimal)
                      </Badge>
                      <Badge
                        variant="outline"
                        className="rounded-full text-[10px] font-bold border-border bg-primary/5 text-primary"
                      >
                        High Protein
                      </Badge>
                    </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {activeDay.schools.map((school, sIdx) => (
                <Card
                  key={sIdx}
                  className="border-border shadow-sm bg-card rounded-2xl overflow-hidden hover:ring-2 hover:ring-primary/20 transition-all"
                >
