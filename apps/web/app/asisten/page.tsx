...
const juknisDocs = [
  {
    id: 1,
    title: "Juknis BGN No. 2/2024",
    category: "Legalitas",
    status: "Active",
  },
  {
    id: 2,
    title: "Panduan Sanitasi MBG",
                ...
                {juknisDocs.map((doc) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      <Badge
                        variant="secondary"
                        className="text-[10px] py-0 bg-green-50 text-green-700 border-green-100"
                      >
                        Ready
                      </Badge>
                    </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 leading-relaxed">
                      Unggah foto untuk deteksi porsi otomatis atau verifikasi
                      NIB/Sertifikat.
                    </p>
                    <Button
                      variant="outline"
                      size="sm"
                      className="mt-3 w-full bg-white border-blue-200 text-blue-600 hover:bg-blue-100"
                    >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {msg.sources.map((src, sIdx) => (
                          <Badge
                            key={sIdx}
                            variant="outline"
                            className="text-[10px] flex items-center gap-1 cursor-pointer hover:bg-slate-50"
                          >
        ...
        <div className="p-4 border-t bg-white">
          ...
          <div className="max-w-3xl mx-auto mt-2 flex justify-center gap-4">
            <p className="text-[10px] text-slate-400">
              AI dapat melakukan kesalahan. Selalu verifikasi data di Juknis
              Resmi.
            </p>
          </div>
        </div>
      ...
      <aside className="w-72 border-l bg-white hidden xl:flex flex-col">
        <div className="p-6 border-b">
          ...
          <p className="text-[10px] text-slate-400 italic">
            Deteksi anomali di halaman aktif
          </p>
        </div>
        <ScrollArea className="flex-1 p-4 space-y-4">
          <div className="p-4 bg-orange-50 border border-orange-100 rounded-xl space-y-2">
            ...
            <p className="text-[11px] text-orange-600 leading-relaxed">
              Kamu sedang di halaman Registrasi. Pastikan NIB berformat RBA
              (Risk Based Approach) agar lolos validasi otomatis.
            </p>
          </div>
          ...
          <div className="p-4 bg-green-50 border border-green-100 rounded-xl space-y-2">
            ...
            <p className="text-[11px] text-green-600 leading-relaxed">
              Standard porsi protein hewani untuk siswa SD adalah minimal 40g
              per paket. Cek panduan Gizi Hal 12.
            </p>
          </div>
        </ScrollArea>
      </aside>
