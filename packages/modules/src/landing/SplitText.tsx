...
export interface SplitTextProps {
  ...
  /** When true, animation resets when element leaves viewport and replays on re-entry */
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  useGSAP(
    () => {
      ...
      // Prevent re-animation if already completed (skip guard when resetOnLeave)
      if (animationCompletedRef.current && !resetOnLeave) return;
